...
int xflag, aa[22], sum[2], cnt[2];
int T, tim, n, knight[2][5], val[22], city[2][22], flag[22], wi[22];
...
void fighting() {
	int k1, k2, tem;
	int total1 = 0, total2 = 0, tt = tim / 60;
