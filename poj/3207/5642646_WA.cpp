...
{
    if(link[i].x>link[j].x&&link[i].x<link[j].y)
        return true;

    if(link[i].y>link[j].x&&link[i].y<link[j].y)
        return true;

    if(link[i].x<link[j].x&&link[j].x<link[i].y)
        return true;

    if(link[i].x<link[j].y&&link[j].y<link[i].y)
        return true;
    return false;
}
int main()
